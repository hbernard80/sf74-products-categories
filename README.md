...
* Relations :
  ...
  * Catégories et sous-catégories (relation réflexive)
* Utilisation d'un trait pour les dates de création et de modification. Lors d'un ajout, la date de modification est définie comme égale à celle de création.
...
* Gestion des listes déroulantes catégorie parente/sous-catégories dans les formulaires : le choix d'une catégorie parente peuple la seconde liste avec les sous-catégories associées (via JS/Stimulus, évènements et réponse JSON)
* Documentation avec PHPDoc, générée dans _00-DOC/code-doc/_ au format HTML
